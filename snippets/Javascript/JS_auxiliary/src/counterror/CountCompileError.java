...
public class CountCompileError {
	public static void main(String[] args) {
		...
		String[] postSplits = { "aa", "ab", "ac", "ad", "ae", "af", "ag", "ah", "ai", "aj", "ak", "al", "am", "an", "ao", "ap", "aq", "ar", "as",
				...
				"cl", "cm", "cn", "co", "cp", "cq", "cr", "cs", "ct", "cu", "cv", "cw", "cx", "cy", "da", "db", "dc", "dd", "de", "df", "dg",
		...
		for (String post : postSplits) {
			...
			//inFile = "C:\\StackOverflow\\Python\\compileError27\\post" + post + "_error.txt";
			inFile = "C:\\StackOverflow\\Python\\compileError34\\post" + post + "_error.txt";
		...
		try {
			//writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\Python\\compileError27\\errorCount.txt")));
			writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\Python\\compileError34\\errorCount.txt")));

...
public class CountParseError {
	public static void main(String[] args) {
		...
		for (String post : postSplits) {
			...
			//inFile = "C:\\StackOverflow\\Python\\parseError27\\post" + post + "_error.txt";
			inFile = "C:\\StackOverflow\\Python\\parseError34\\post" + post + "_error.txt";
		...
		try {
			//writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\Python\\parseError27\\errorCount.txt")));
			writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\Python\\parseError34\\errorCount.txt")));

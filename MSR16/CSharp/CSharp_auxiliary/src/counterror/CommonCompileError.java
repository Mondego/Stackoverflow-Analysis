...
public class CommonCompileError {
	...
	public static void main(String[] args) {
		...
		for (String post : postSplits) {
			...
			inFile = "C:\\StackOverflow\\C#\\compileErrorInitial\\post"+ post + "_error.txt";
			//inFile = "C:\\StackOverflow\\C#\\compileErrorAfterRemoves\\post"+ post + "_error.txt";
			//inFile = "C:\\StackOverflow\\C#\\compileErrorAfterFix2\\post"+ post + "_error.txt";
		...
		try {
			//writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorInitial\\errorCount.txt")));
			writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorAfterRemoves\\errorCount.txt")));
			//writer1 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorAfterFix2\\errorCount.txt")));
			for (Map.Entry<String, Integer> entry : errorList) {
				writer1.write(entry.getKey() + "Di2015UniqueSeparator"+ entry.getValue() + "\n");
			}
			writer1.close();
			
			//writer2 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorInitial\\errMsg.txt")));
			writer2 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorAfterRemoves\\errMsg.txt")));
			//writer2 = new BufferedWriter(new FileWriter(new File("C:\\StackOverflow\\C#\\compileErrorAfterFix2\\errMsg.txt")));
